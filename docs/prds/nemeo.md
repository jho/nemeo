...
- **Suggest** capabilities expose data and supported proposals for a change, intervention, target, report, or next step. Proposals show expected impact and supporting evidence, remain non-mutating until accepted, and can be dismissed, snoozed, or regenerated by the consuming experience.
